...
class Granary {
    constructor(GranaryInfo, network, web3, heavyUpdateInterval = 24) {
      this.web3 = web3
      this.network = network
      this.lendingPoolAddressesProvider = new web3.eth.Contract(Addresses.lendingPoolAddressesProviderAbi, GranaryInfo[network].lendingPoolAddressesProviderAddress)

      this.multicall = new web3.eth.Contract(Addresses.multicallAbi, Addresses.multicallAddress[network])
      this.deployBlock = GranaryInfo[network].deployBlock
      this.blockStepInInit = GranaryInfo[network].blockStepInInit
      this.multicallSize = GranaryInfo[network].multicallSize
