...
async function testETH() {
  ...
  for (const calderon of ethCalderons) {
    const mimInfo = { ETH: { blockStepInInit: 500000, multicallSize: 200, calderons: [calderon] } };
...
async function testFTM() {
  ...
  for (const calderon of ftmCalderons) {
    const mimInfo = { FTM: { blockStepInInit: 500000, multicallSize: 200, calderons: [calderon] } };
...
async function testAVAX() {
  ...
  for (const calderon of avaxCalderons) {
    const mimInfo = {
      AVAX: { blockStepInInit: 500000, multicallSize: 200, calderons: [calderon] },
    };
...
async function testBSC() {
  ...
  for (const calderon of bscCalderons) {
    const mimInfo = { BSC: { blockStepInInit: 500000, multicallSize: 200, calderons: [calderon] } };
...
async function testArbitrum() {
  ...
  for (const calderon of arbitrumCalderons) {
    const mimInfo = {
      ARBITRUM: { blockStepInInit: 50000, multicallSize: 200, calderons: [calderon] },
    };
