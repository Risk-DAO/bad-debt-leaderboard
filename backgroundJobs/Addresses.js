...
const calderonAbi = [
  {
    inputs: [
      { internalType: 'contract IBentoBoxV1', name: 'bentoBox_', type: 'address' },
      { internalType: 'contract IERC20', name: 'magicInternetMoney_', type: 'address' },
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint128', name: 'accruedAmount', type: 'uint128' }],
    name: 'LogAccrue',
    type: 'event',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: 'to', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'part', type: 'uint256' },
    ],
    name: 'LogBorrow',
    type: 'event',
  },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'feeTo', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'feesEarnedFraction', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [],
    name: 'masterContract',
    outputs: [{ internalType: 'contract CauldronV2', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
const compoundOracleAbi = [
  ...
  {
    constant: true,
    inputs: [{ internalType: 'contract CToken', name: 'cToken_', type: 'address' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { internalType: 'address', name: 'feed_', type: 'address' },
...
const usdcAddress = {
  ...
  NEAR: '0xB12BFcA5A55806AaF64E99521918A4bf0fC40802',
...
const rariTetranodeAddress = {
  ETH: {
    comptroller: '0x814b02C1ebc9164972D888495927fe1697F0Fb4c',
    cETH: '0xF6551C22276b9Bf62FaD09f6bD6Cad0264b89789',
    deployBlock: 12860109,
    blockStepInInit: 50000,
    multicallSize: 500,
  },
};
...
const venusAddress = {
  BSC: {
    ...
    cETH: '0xA07c5b74C9B40447a954e1466938b865b6BBea36',
    deployBlock: 2471512,
...
const traderJoeAddress = {
  AVAX: {
    ...
    cETH: '0xdc13687554205E5b89Ac783db14bb5bba4A1eDaC',
    deployBlock: 5449252,
    blockStepInInit: 2048,
    multicallSize: 100,
  },
};
...
const benqiAddress = {
  AVAX: {
    ...
    cETH: '0x5C0401e81Bc07Ca70fAD469b451682c0d747Ef1c',
    deployBlock: 3046286,
    blockStepInInit: 2048,
    multicallSize: 100,
  },
...
const ironBankAddress = {
  ETH: {
    comptroller: '0xAB1c342C7bf5Ec5F02ADEA1c2270670bCa144CbB',
    cETH: '0xAB1c342C7bf5Ec5F02ADEA1c2270670bCa144CbB',
    deployBlock: 11384868,
    blockStepInInit: 50000,
    multicallSize: 100,
  },
};
...
const ovixAddress = {
  MATIC: {
    comptroller: '0x8849f1a0cB6b5D6076aB150546EddEe193754F1C',
    cETH: '0xE554E874c9c60E45F1Debd479389C76230ae25A8',
    deployBlock: 26312398,
    blockStepInInit: 10000,
    multicallSize: 100,
  },
};

const bastionAddress = {
  NEAR: {
    comptroller: '0x6De54724e128274520606f038591A00C5E94a1F6',
    cETH: '0x4E8fE8fd314cFC09BDb0942c5adCC37431abDCD0',
    deployBlock: 60837829,
    blockStepInInit: 10000,
    multicallSize: 20,
  },
};

const apeSwapAddress = {
  BSC: {
    comptroller: '0xAD48B2C9DC6709a560018c678e918253a65df86e',
    cETH: '0x34878F6a484005AA90E7188a546Ea9E52b538F6f',
    deployBlock: 12871489,
    blockStepInInit: 50000,
    multicallSize: 20,
  },
};
...
const rikkiAddress = {
  BSC: {
    comptroller: '0x4f3e801Bd57dC3D641E72f2774280b21d31F64e4',
    cETH: '0x157822aC5fa0Efe98daa4b0A55450f4a182C10cA',
    deployBlock: 15341030,
    blockStepInInit: 50000,
    multicallSize: 20,
  },
};
...
const inverseAddress = {
  ETH: {
    ...
    cETH: '0x8e103Eb7a0D01Ab2b2D29C91934A9aD17eB54b86',
...
const moonwellAddress = {
  MOONBEAM: {
    comptroller: '0x8E00D5e02E65A19337Cdba98bbA9F84d4186a180',
    cETH: '0x091608f4e4a15335145be0A279483C0f8E4c7955',
    deployBlock: 1284556,
    blockStepInInit: 2000,
    multicallSize: 20,
  },
};
...
const creamAddress = {
  BSC: {
    ...
    cETH: '0x1Ffe17B99b439bE0aFC831239dDECda2A790fF3A',
    deployBlock: 100320,
    blockStepInInit: 5000,
    multicallSize: 20,
  },
...
const granaryAddress = {
  FTM: {
    lendingPoolAddressesProviderAddress: '0x8b9D58E2Dc5e9b5275b62b1F30b3c0AC87138130',
    deployBlock: 32461920,
    blockStepInInit: 100000,
    multicallSize: 200,
  },
};

const tectonicAddress = {
  CRO: {
    comptroller: '0xb3831584acb95ED9cCb0C11f677B5AD01DeaeEc0',
    cETH: '0xeAdf7c01DA7E93FdB5f16B0aa9ee85f978e89E95',
    deployBlock: 570286,
    blockStepInInit: 2000,
    multicallSize: 20,
  },
...
const sonneAddress = {
  OPTIMISM: {
    ...
    cETH: '0xf7B5965f5C117Eb1B5450187c9DcFccc3C317e8E',
...
const aaveV3poolAddressesProviderRegistryAbi = [
  {
    inputs: [{ internalType: 'address', name: 'owner', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'constructor',
...
const aaveV3poolAddressProviderAbi = [
  {
    inputs: [
...
const aaveV3PriceOracleABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'baseCurrency', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'baseCurrencyUnit', type: 'uint256' },
    ],
...
module.exports = {
  ...
  lendingPoolAbi,
  compoundAddress,
  compoundV3WethAddress,
  compoundV3UsdcAddress,
  multicallAddress,
  oneInchOracleAddress,
  usdcAddress,
  venusAddress,
  rariTetranodeAddress,
  traderJoeAddress,
  benqiAddress,
  bastionAddress,
  agaveAddress,
  ...
  moonwellAddress,
  aaveV3Configuration,
  aaveV3poolAddressesProviderRegistryAbi,
  aaveV3poolAddressProviderAbi,
  aaveV3PoolAbi,
